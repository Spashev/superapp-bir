<div class="td w-150">
    <td class="operations">
        <a href="#" class="btn-icon btn btn-primary-light" data-toggle="tooltip"
        ...
        <a href="{{ $edit }}" class="btn-icon btn btn-info-light ml-1" data-toggle="tooltip"
        ...
        <form method="post"
            ...
            @csrf
            @method('DELETE')
            <button type="submit" class="delete-btns btn-icon btn btn-danger-light ml-1"
                    data-id="1" data-toggle="tooltip" title=""
                ...
                <svg fill="#ed3472" viewBox="0 0 1024 1024">
                    ...
                    <path class="path2"
                          d="M640 358.4c-14.139 0-25.6 11.462-25.6 25.6v512c0 14.139 11.461 25.6 25.6 25.6s25.6-11.461 25.6-25.6v-512c0-14.138-11.461-25.6-25.6-25.6z"></path>
                    <path class="path3"
                          d="M486.4 358.4c-14.138 0-25.6 11.462-25.6 25.6v512c0 14.139 11.462 25.6 25.6 25.6s25.6-11.461 25.6-25.6v-512c0-14.138-11.462-25.6-25.6-25.6z"></path>
                    <path class="path4"
                          d="M332.8 358.4c-14.138 0-25.6 11.462-25.6 25.6v512c0 14.139 11.462 25.6 25.6 25.6s25.6-11.461 25.6-25.6v-512c0-14.138-11.462-25.6-25.6-25.6z"></path>
                </svg>
            </button>
        </form>
    </td>
