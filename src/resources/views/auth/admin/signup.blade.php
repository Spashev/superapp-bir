    ...
    <div class="panel">
        <div class="row no-gutters">
                    ...
                    <form action="{{ route('admin.signup') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-merged">
                                    <input type="text" name="full_name" class="form-control" id="inputFName" placeholder="Full Name" value="{{ old('full_name') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputLName">IIN</label>
                                <div class="input-group input-group-merged">
                                    <input type="text" name="iin" class="form-control" id="inputLName" placeholder="IIN" value="{{ old('iin') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text bg-white">
                                            <i class="fas fa-user"></i>
                                        </span>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-merged">
                                    <input type="text" name="email" class="form-control" id="inputEmail" placeholder="Email" value="{{ old('email') }}" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text bg-white">
                        ...
                        <div class="form-group form-group-btns text-center mb-0">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <a href="{{route('admin.signin')}}" class="btn btn-block btn-lg btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="panel-body panel-image" style="background-image: url('{{asset("assets/media/auth/tim-bennett-OwvRB-M3GwE-unsplash-full.jpg") }}');">
