        ...
        <div class="panel-body">
            <div class="flex-table-responsive">
                <div class="flex-table-2 flex-table-separated flex-table-shadowed flex-table-rounded-circle">
                    <button type="button" class="mb-2 btn btn-rounded btn-has-icon btn-icon-split btn-outline-primary" data-toggle="modal" data-target="#add-tag">
                    ...
                    <div class="tbody">
                        @foreach ($amenities as $amenity)
                            <div class="tr">
                                ...
                                <div class="td">{{$amenity->name}}</div>
                                <div class="td"><i class="{{$amenity->icon}}" style="font-size: 18px;"></i></div>
                                <div class="td">
                                    ...
                                    @else
                                        <small>
                                            <span class="badge color-badge color-badge-small badge-danger"></span> Drafted
                                        </small>
                                    @endif
                                </div>
                                <div class="td">{{date('d-m-Y', strtotime($amenity->created_at))}}</div>
                                <x-buttons.three :delete="route('admin.amenity.destroy', $amenity->id)" :edit="route('admin.amenity.edit', $amenity->id)" />
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">New amenity</h5>
